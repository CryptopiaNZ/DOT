...
unlocked to sign the Dotcoin-Qt.app bundle.
...
allowing somebody to distribute a Dotcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the Dotcoin-qt.exe file inside the installer had not been tampered with.
