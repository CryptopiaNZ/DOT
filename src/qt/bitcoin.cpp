...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Kimdotcoin can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Kimdotcoin");
    QApplication::setOrganizationDomain("coingen.io");
    QApplication::setApplicationName("Kimdotcoin-Qt");
